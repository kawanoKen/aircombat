...
def parse_args():
    ...
    parser.add_argument('--myagent-module-path', default = 'Test')
    parser.add_argument('--opponent-id', type = str, default = '1')
    parser.add_argument('--opponent-module-path', default = 'BenchMark')
    ...
    parser.add_argument('--max-size', default = 0.01, type = float)
